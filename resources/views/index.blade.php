...
<link rel="mask-icon" href="{{ asset('img/icons/safari-pinned-tab.svg') }}" color="#712cf9">
...
<script src="{{ asset('js/chart.umd.min.js') }}" integrity="sha384-gdQErvCNWvHQZj6XZM0dNsAoY4v+j5P1XDpNkcM3HJG1Yx04ecqIHk7+4VBOCHOG" crossorigin="anonymous"></script><script src="{{ asset('js/dashboard.js') }}"></script></body>
</html>
