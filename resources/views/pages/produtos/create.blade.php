...
<form method="POST" action="{{ route('cadastrar.produto') }}">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="nome_produto" class="form-control @error('nome_produto') is-invalid @enderror">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="tipo_produto" class="form-control @error('tipo_produto') is-invalid @enderror">
        ...
        <div class="mb-3">
          ...
          <input id="mascara-valor" name="valor" class="form-control @error('valor') is-invalid @enderror">
          @if ($errors->has('valor'))
